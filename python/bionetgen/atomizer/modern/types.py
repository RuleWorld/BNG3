...
DEFAULT_NAMING_PATTERNS = {
    ...
    ("+ _", "+ p"): "Phosphorylation",
    ("+ _", "+ P"): "Phosphorylation",
    ("+ p", "+ h", "+ o", "+ s"): "Phosphorylation",
    ("+ p", "+ h", "+ o", "+ s", "+ p", "+ h", "+ o"): "Phosphorylation",
    ...
    ("+ u", "+ b"): "Ubiquitination",
    ("+ U", "+ b"): "Ubiquitination",
    ("+ _", "+ u", "+ b"): "Ubiquitination",
    ("+ _", "+ U", "+ b"): "Ubiquitination",
    ("+ u", "+ b", "+ i", "+ q"): "Ubiquitination",
    ("+ a", "+ c"): "Acetylation",
    ("+ A", "+ c"): "Acetylation",
    ("+ _", "+ a", "+ c"): "Acetylation",
    ("+ a", "+ c", "+ e", "+ t"): "Acetylation",
    ...
    ("+ _", "+ A"): "Activation",
    ("+ _", "+ a", "+ c", "+ t"): "Activation",
    ("+ a", "+ c", "+ t", "+ i", "+ v", "+ e"): "Activation",
    ("+ i",): "Inactivation",
    ("+ I",): "Inactivation",
    ("+ _", "+ i"): "Inactivation",
    ("+ _", "+ I"): "Inactivation",
    ("+ i", "+ n", "+ a", "+ c", "+ t"): "Inactivation",
    ("+ _",): "Binding",
    ("+ _", "+ b", "+ o", "+ u", "+ n", "+ d"): "Binding",
    ("+ _", "+ c", "+ y", "+ t"): "Localization",
    ("+ _", "+ n", "+ u", "+ c"): "Localization",
    ("+ _", "+ m", "+ e", "+ m"): "Localization",
    ("+ _", "+ p", "+ m"): "Localization",
    ("+ _", "+ e", "+ r"): "Localization",
    ("+ 2",): "Dimerization",
    ("+ _", "+ d", "+ i", "+ m"): "Dimerization",
    ("+ _", "+ d", "+ i", "+ m", "+ e", "+ r"): "Dimerization",
    ("+ 3",): "Trimerization",
