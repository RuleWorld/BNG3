...
def _flatten_type(
    ...
    if not children:
        molecule = _FlatMolecule(
            ...
            compartment=inherited_compartment,
        )
        ...
        for instance in species_type.instances:
            ...
            if instance.compartment_reference:
                ...
                if not instance_compartment:
                    ...
                    inherited_compartment
                    and instance_compartment != inherited_compartment
                ):
                    warnings.append(
                        _warning(
    ...
    for instance in children:
        ...
        child = _flatten_type(
            ...
            instance_compartment or inherited_compartment,
        )
