...
#include <vector>
namespace NFcore2 {
enum MatchOpcode { MATCH_TYPE_EXISTS, MATCH_STATE_MASK, MATCH_STATE_NOT_EQUAL, MATCH_BOND_PRESENT, MATCH_BOND_FREE, MATCH_BOND_TO, MATCH_POPULATION_AT_LEAST, MATCH_COMPARTMENT, MATCH_CONNECTED_TO, MATCH_SCAFFOLD_STATE, MATCH_SCAFFOLD_FREE, MATCH_END };
