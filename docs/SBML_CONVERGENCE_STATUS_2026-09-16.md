...
- The final full SBML Test Suite report is `/private/tmp/bng3-sbml-suite-final-audited.json` (schema 3): all 1,923 pinned cases were selected; 673 passed, 1,250 were explicitly unsupported, 0 failed, and 0 timed out. Of the 673 cases reaching export/reimport, 585 carried source metadata and all 585 payloads matched exactly; 88 had no source metadata. The report is an import/round-trip gate, not a claim of numerical SBML Test Suite conformance.
