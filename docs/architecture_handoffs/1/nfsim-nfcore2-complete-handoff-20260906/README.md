...
Package contents:
- `src/NFcore2/` — latest implementation source.
- `tests/NFcore2/` — latest live tests, benchmark, and future-red specifications.
- `patches/` — latest implementation/introspection/testing patch artifacts.
- `history/` — earlier milestone patches and reports for provenance.
